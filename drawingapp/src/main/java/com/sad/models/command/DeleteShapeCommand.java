...
/**
 * Command to delete a specific shape from the model.
 ...
 */
public class DeleteShapeCommand implements CommandInterface {
    ...
    /**
     * Constructs a DeleteShapeCommand.
     ...
     */
    public DeleteShapeCommand(Model receiver, ShapeInterface shape) {
    ...
    /**
     * Executes the command, deleting the shape from the model.
     */
    @Override
    public void execute() {
        receiver.deleteShape(shape);
    }
